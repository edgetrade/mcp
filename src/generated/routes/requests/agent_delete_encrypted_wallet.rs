...
pub const ROUTE: Route<DeleteEncryptedWalletRequest, DeleteEncryptedWalletResponse> = Route {
    procedure: "agent.deleteEncryptedWallet",
...
///Input for deleting an encrypted wallet from an agent
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "description": "Input for deleting an encrypted wallet from an agent",
///  "type": "object",
///  "required": [
///    "walletAddress"
///  ],
...
///    }
///  },
///  "name": "Delete Encrypted Wallet"
///}
/// ```
/// </details>
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
pub struct DeleteEncryptedWalletRequest {
    ///The wallet address to delete
...
pub struct DeleteEncryptedWalletResponse {
